        ...
        <div className="col s12 m4 blue-grey lighten-2">
            <div className="card t">
                ...
                <div className="card-content" style={{backgroundColor:'black', color:'white', textAlign:'center', marginBottom:5}} >
                    ...
                    <div id="profession" style= {{backgroundColor:'black', color:'white', textAlign:'center', marginBottom:5, fontSize:12}} > {this.props.professionName.toUpperCase()}</div>
                    <div id="firstName" style= {{backgroundColor:'teal', color:'white', textAlign:'center', marginBottom:5, fontSize:14}} >{this.props.firstName.toUpperCase()} {this.props.lastName.toUpperCase()}</div>	
